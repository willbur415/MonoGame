...
namespace MonoGame.Tools.Pipeline
{
    partial class MainWindow
    {
        ...
        private void InitalizeCommands()
        {
            ...
            cmdNew.ToolTip = "New";
            cmdNew.Image = Icon.FromResource("Toolbar.New.png");
            cmdNew.MenuText = "New...";

            cmdOpen = new Command();
            cmdOpen.MenuText = "Open...";
            cmdOpen.ToolTip = "Open";
            cmdOpen.Image = Icon.FromResource("Toolbar.Open.png");
            ...
            cmdSave.Image = Icon.FromResource("Toolbar.Save.png");
            ...
            cmdUndo.Image = Icon.FromResource("Toolbar.Undo.png");
